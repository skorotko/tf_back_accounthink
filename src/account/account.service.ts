...
import { QueryTypes } from 'sequelize'; // Импортируем типы из sequelize
...
export class AccountService {
  ...
  async getAccountsTreeByCompanyId(companyId: number) {
    try {
      return await this.accountRepository.sequelize.query(
        AccountQueries.getAccountsTree, // TS знает, что тут строка
        {
