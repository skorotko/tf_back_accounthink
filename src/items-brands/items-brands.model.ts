...
interface ItemsBrandsCreateAttrs {
  companyId: number;
  name: string;
  code: string;
}

@Table({ tableName: 'itemsBrands', createdAt: true, updatedAt: true })
export class ItemsBrands extends Model<ItemsBrands, ItemsBrandsCreateAttrs>{
